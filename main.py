...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='./data/spkr-indep/fold0',
                        help=f'Specify the full path to the features+labels file.')
    parser.add_argument('--model_dir', type=str, default='./models/checkpoints/spkr-indep/fold0',
                        help=f'Specify the output directory.')
    parser.add_argument('--out_dir', type=str, default='./results/spkr-indep/fold0',
                        help=f'Specify the output directory.')
